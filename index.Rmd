...
q_3_1_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_1)
...
```{r, include=FALSE}
q_3_2_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_2)
...
```{r, include=FALSE}
q_3_3_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_3)
...
```{r, include=FALSE}
q_3_4_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_4)
...
```{r, include=FALSE}
q_3_5_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_5)
...
```{r, include=FALSE}
q_3_6_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_6)
...
```{r, include=FALSE}
q_3_7_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_3_7)
...
```{r, include=FALSE}
q_4_1_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_1)
...
```{r, include=FALSE}
q_4_2_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_2)
...
```{r, include=FALSE}
q_4_3_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_3)
...
```{r, include=FALSE}
q_4_4_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_4)
...
```{r, include=FALSE}
q_4_5_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_5)
...
```{r, include=FALSE}
q_4_6_smry <- smry_df(wy_bilt, survey_number, response_id, q_8, q_4_6)
